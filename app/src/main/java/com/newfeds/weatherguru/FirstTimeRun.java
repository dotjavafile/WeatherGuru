...
public class FirstTimeRun extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        autoCompleteTextViewCityChooser = (AutoCompleteTextView) findViewById(R.id.autoCompleteTextView);
    ...
    class CityLoader extends AsyncTask<Void,Void,Void>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = ProgressDialog.show(FirstTimeRun.this,"Loading City List", "Please wait...");
